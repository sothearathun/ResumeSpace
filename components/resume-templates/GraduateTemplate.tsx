...
export function GraduateTemplate({
  content,
  appearance,
}: {
  ...
  return (
    ...
    >
      ...
      <div className="mt-(--section-gap) flex flex-col gap-(--section-gap)">
            ...
            <div className="flex flex-col gap-2">
              {education.map((edu) => (
                <div key={edu.id}>
                  ...
                  {edu.gpa && <p className="text-[0.8em] text-neutral-600">GPA: {edu.gpa}</p>}
                  {edu.coursework && (
                    <p className="text-[0.8em] text-neutral-600">Coursework: {edu.coursework}</p>
                  )}
                </div>
              ))}
            </div>
        ...
        {projectBlocks.length > 0 && <OptionalSectionBlocks blocks={projectBlocks} />}
